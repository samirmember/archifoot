...
class FixtureCompleteType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('matchday', EntityType::class, ['class' => Matchday::class, 'choice_label' => 'name', 'required' => false])
            ->add('division', EntityType::class, ['class' => Division::class, 'choice_label' => 'name', 'required' => false])
            ...
            ->add('city', EntityType::class, ['class' => City::class, 'choice_label' => 'name', 'required' => false])
