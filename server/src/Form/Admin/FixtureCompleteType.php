...
class FixtureCompleteType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('matchday', EntityType::class, ['class' => Matchday::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
            ->add('division', EntityType::class, ['class' => Division::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
            ->add('category', EntityType::class, ['class' => Category::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
            ->add('matchDate', DateType::class, ['widget' => 'single_text', 'required' => false])
            ->add('stadium', EntityType::class, ['class' => Stadium::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
            ->add('city', EntityType::class, ['class' => City::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
            ->add('country', EntityType::class, ['class' => Country::class, 'choice_label' => 'name', 'required' => false, 'attr' => ['data-live-min3' => '1']])
