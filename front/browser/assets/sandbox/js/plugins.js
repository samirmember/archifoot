...
(function (global, factory) {
  ...
  const getSelector = (element) => {
    ...
    if (!selector || selector === '#') {
      ...
      selector =
        hrefAttribute && hrefAttribute !== '#' ? parseSelector(hrefAttribute.trim()) : null;
    }
    return selector;
  };
      ...
      686: function (t, e, n) {
        ...
        function h(n) {
          ...
          return function () {
            ...
            return (
              (t = o
                ? ((t = m(this).constructor), Reflect.construct(e, arguments, t))
        ...
        for (let e = 0; e < i.length; e++)
          if (/([0-9.][,.0-9]*[0-9]*)/.test(i[e]) && !/<[^>]+>/.test(i[e])) {
            ...
            for (let e = r; e >= 1; e--) {
              ...
              ((i = n.reduce(
                (e, { char: t, i: n }) => (e.length <= n ? e : e.slice(0, -n) + t + e.slice(-n)),
                i.toString(),
              )),
                (u[o--] += i));
            }
    ...
    e = function (t, e) {
      ...
      return function () {
        ...
        return (
          ...
          (o = arguments),
          0 >= h
            ? (clearTimeout(l), (l = null), (c = f), (i = t.apply(s, o)), (s = o = null))
            : l || (l = setTimeout(r, h)),
          i
        );
      };
      ...
      stick: function () {
        this.visible ||
          ((this.clonedElem.className = this.clonedElem.className.replace(
            new RegExp('(^|\\s)*' + this.options.classes.unstick + '(\\s|$)*', 'g'),
            '',
          )),
...
class iTooltip {
  ...
  init(t = {}) {
    if (
      ((this.settings = Object.assign(
        { className: 'tooltip', indentX: 10, indentY: 15, positionX: 'right', positionY: 'bottom' },
        t,
      )),
  ...
  changePosition(t) {
    ...
    if (
      ...
      n = o.top <= i ? s + t.clientY + this.settings.indentY : t.pageY - i - this.settings.indentY;
    ...
    ((o =
      ...
      (s.parseSets = function (a, b, d) {
        var e,
          ...
          j = a[s.ns];
        ((j.src === c || d.src) &&
          ((j.src = w.call(a, 'src')), j.src ? x.call(a, C, j.src) : y.call(a, C)),
      ...
      s.supPicture
        ...
        : !(function () {
            var c,
              ...
              i = function () {
                ((M =
                  Math.max(a.innerWidth || 0, z.clientWidth) !== Q.width || z.clientHeight !== h),
                  (h = z.clientHeight),
                  M && s.fillImgs());
              };
...
'object' == typeof navigator &&
  (function (e, t) {
    ...
    const _e = (e = '', t = '', i = '') =>
      ...
      Oe = (e = '') =>
        e.toString().replace(/\w\S*/g, (e) => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase());
    function je(e = '') {
      let t = e.toString();
      return (
        (t = (function (e = '') {
    ...
    const We = {
      ...
      create(e) {
        ...
        return (
          Ce(D(this.config.controls) ? this.config.controls : []).forEach((l) => {
            if (
      ...
      setMarkers() {
        ...
        (i.forEach((e) => {
          ...
          s.appendChild(n),
          this.config.tooltips.seek ||
            ((a = Z('span', { class: this.config.classNames.tooltip }, '')), s.appendChild(a)),
    ...
    class st {
      constructor(t) {
        (e(this, 'onChange', () => {
          ...
          const t =
            this.target === this.player.media ? this.target : this.player.elements.container;
      ...
      constructor(t) {
        (e(this, 'load', () => {
          ...
          e(this, 'onAdEvent', (e) => {
            ...
            switch (
              ...
              case google.ima.AdEvent.Type.LOG:
                s.adError &&
                  this.player.debug.warn(`Non-fatal ad error: ${s.adError.getMessage()}`);
            }
          }),
          e(this, 'onAdError', (e) => {
          ...
          e(
            this,
            'on',
            (e, t) => (D(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this),
          ),
    ...
    class Tt {
      constructor(t, i) {
        if (
          ...
          ((window.jQuery && this.media instanceof jQuery) || q(this.media) || D(this.media)) &&
            ...
            (!(function () {
              ...
              (function (a) {
                ...
                function c(a) {
                  var b = a.match(v);
                  return (
                    b ? (1 === b.length || a[0].match(u)) && b.unshift('') : (b = ['', '']),
                    b.join(A)
                  );
                }
                function d(b) {
...
!(function (a, b) {
  ...
  ((e.prototype.init = function () {
    ...
    (e.prototype.start = function () {
      (this.running !== !0 &&
        ((this.running = !0), this.changeWord(this.words[this.position]), this.position++),
        (this.loop = setTimeout(this.changeAnimation.bind(this), this.options.speed)));
    }),
    (e.prototype.change = function () {
      return this.position > this.count - 1 &&
        ((this.position = 0), this.loopCount++, this.loopCount >= this.options.loopCount)
        ? void this.stop()
...
$jscomp.polyfillIsolated = function (a, b, e, f) {
  ...
  null != b &&
    (a
      ? $jscomp.defineProperty($jscomp.polyfills, h, { configurable: !0, writable: !0, value: b })
      : b !== e &&
  ...
  a = {
        ...
        return (
          Object.keys(g).forEach(function (b) {
            '[object Object]' === Object.prototype.toString.call(g[b])
              ...
              : ((d[b] = g[b]),
                'undefined' !== typeof c && 'undefined' !== typeof c[b] && (d[b] = c[b]));
          }),
          d
        );
    },
    ...
    sortElements: function () {
      for (
        ...
        d = { $jscomp$loop$prop$i$4: d.$jscomp$loop$prop$i$4 }, d.$jscomp$loop$prop$i$4++
      )
        a.sort(
          (function (a) {
            return function (g, d) {
    ...
    getOrderNumber: function (a) {
      return a.hasAttribute('data-order')
        ? ((a = Number(a.getAttribute('data-order'))), 0 <= a ? a : Math.pow(2, 53) - 1 + a)
        : Math.pow(2, 52) - 1;
    },
    ...
    getOffsetTop: function (a) {
      return (
        a.getBoundingClientRect().top + (window.pageYOffset || document.documentElement.scrollTop)
      );
    },
    ...
    runQuery: function () {
      for (
        ...
        if (
          ((c.$jscomp$loop$prop$elms$6 = e[b[d]]), a.isElementIn(c.$jscomp$loop$prop$elms$6[0].elm))
        ) {
            ...
            (function (c) {
              return function (b) {
                ...
                c.$jscomp$loop$prop$elms$6[b].elm.style.animationDelay =
                  c.$jscomp$loop$prop$interval$7 + c.$jscomp$loop$prop$elms$6[b].delay + 'ms';
  ...
  const me = [
    ...
    function (e) {
      ...
      function E(e) {
        ...
        let r;
        ((r =
          (y(e) - w(i)[t.isHorizontal() ? 'left' : 'top'] - (null !== d ? d : c / 2)) / (p - c)),
